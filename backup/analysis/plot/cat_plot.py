    ...
    def _make_attribute_metric_map(
        ...
        if None in unique_values:
            ...
            if "None" in unique_values:
                ...
                ), f"{none_name} is also present as a categorical. Highly unlikely it is by accident. Make up your mind."
...
class ViolinPlot(Categorical):
    ...
    def _make(
        ...
        **kwargs,
        ...
        median_perf = []
        best_perf = []
        for i, (name, vals) in enumerate(self.attribute_metric_map.items()):
